...
#define ROWS 60
#define COLS 80
void draw_state(int cells[ROWS][COLS], sf::RenderTarget &window, sf::Uint8 *pixels, sf::Texture &texture, sf::Sprite &sprite)
{
...
void step(int cells[ROWS][COLS], int copy[ROWS][COLS])
{
